...
public class MainActivity extends AppCompatActivity {
    ...
    private void translateText(int fromLanguageCode, int toLanguageCode, String sourceText) {
        ...
        translator.downloadModelIfNeeded(conditions).addOnSuccessListener(unused -> {
            ...
            translator.translate(sourceText).addOnSuccessListener(s -> translatedTV.setText(s)).addOnFailureListener(e -> Toast.makeText(MainActivity.this, "Fail to translate: " + e.getMessage(), Toast.LENGTH_SHORT).show());
        }).addOnFailureListener(e -> Toast.makeText(MainActivity.this, "Fail to download language Modal: " + e.getMessage(), Toast.LENGTH_SHORT).show());
    }
